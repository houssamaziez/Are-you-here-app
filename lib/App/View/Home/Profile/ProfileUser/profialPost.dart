...
import 'package:app/App/View/Home/Profile/ProfileUser/initsate/profileinitState.dart';
import 'package:app/App/View/Home/Profile/ProfileUser/widgets/imagePorofile.dart';
...
class _ProfilePostState extends State<ProfilePost> {
  ...
  void initState() {
    super.initState();
    initStateprofile(context, widget.post.likes!, widget.post.id.toString());
  }
    ...
    return PieCanvas(
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              imageprofile(context, widget.post),
              Column(
                children: [
                  SizeApp.sizedboxh10,
                  Container(
